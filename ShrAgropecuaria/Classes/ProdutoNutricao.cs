...
namespace ShrAgropecuaria.Classes
{
    public class ProdutoNutricao
    {
        ...
        public int Prodn_previsaoentrega { get => prodn_previsaoentrega; set => prodn_previsaoentrega = value; }

        public string Categoria { get { return tipoProdutoNutricao?.Tpn_descricao; } }
    }
}
